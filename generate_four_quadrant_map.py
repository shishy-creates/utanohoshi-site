...
def manual_missing_annotations() -> List[Dict]:
    return [
        ...
        },
        {
            "id": 134,
            "title": "マイライフ",
            "axes": {"reality_to_cosmos": 0.42, "material_to_spiritual": 0.82, "warning_to_hope": 0.68},
            "tags": ["命", "祈り", "光", "赦し", "生きる", "祝福"],
            "summary": "生きていることへの問いを、朝の光と天への祈りへ返していく歌。罪ではなく祝福として命を抱きしめる。",
        },
        {
            "id": 135,
            "title": "みんなステラ",
            "axes": {"reality_to_cosmos": 0.8, "material_to_spiritual": 0.65, "warning_to_hope": 0.82},
            "tags": ["星", "つながり", "光", "ありがとう", "冬空", "奇跡"],
            "summary": "一人ひとりを星として見つめ、つながりの重力と感謝を歌う曲。寒空の下でも互いの光を信じる。",
        },
        {
            "id": 136,
            "title": "反転世界の渦の外",
            "axes": {"reality_to_cosmos": 0.65, "material_to_spiritual": 0.78, "warning_to_hope": 0.45},
            "tags": ["反転世界", "渦", "権力", "祈り", "手放す", "再生"],
            "summary": "力の世界に呑まれる渦の外へ出て、祈りと愛するままの地点へ向かう歌。反転した世界をほどいていく。",
        },
        {
            "id": 137,
            "title": "汚れたけど、僕の青さ",
            "axes": {"reality_to_cosmos": 0.35, "material_to_spiritual": 0.55, "warning_to_hope": 0.72},
            "tags": ["青", "素直", "赦し", "自分", "歌", "希望"],
            "summary": "汚れても消えない自分の青さを守る歌。弱さや不器用さを抱えたまま、もう一度自分の声で歌おうとする。",
        },
        {
            "id": 138,
            "title": "レラカムイの風刃（ふうじん）",
            "axes": {"reality_to_cosmos": 0.78, "material_to_spiritual": 0.9, "warning_to_hope": 0.48},
            "tags": ["風", "神", "刃", "祓い", "浄化", "誓い"],
            "summary": "風の神の刃が欺瞞を裂き、忘れられていた誓いを果たす歌。祓いと浄化の力が命を守る。",
        },
        {
            "id": 139,
            "title": "エンシェント・ワンワールド",
            "axes": {"reality_to_cosmos": 0.86, "material_to_spiritual": 0.88, "warning_to_hope": 0.86},
            "tags": ["古代", "世界", "大地", "精霊", "祈り", "感謝"],
            "summary": "大地と精霊、星と朝日のもとで、ひとつだけの世界を生きる祈りの歌。古代的な感謝が未来へひらく。",
        },
        {
            "id": 140,
            "title": "CODE:GIZA　コード・ギザ",
            "axes": {"reality_to_cosmos": 0.8, "material_to_spiritual": 0.84, "warning_to_hope": 0.38},
            "tags": ["星", "門", "王", "コード", "真実", "創造"],
            "summary": "隠されたコードと奪われた真実を、星と太陽のまなざしで暴いていく歌。創造の扉が開かれる。",
        },
        {
            "id": 141,
            "title": "ドラゴニック・エイジ  − Draconic Age",
            "axes": {"reality_to_cosmos": 0.78, "material_to_spiritual": 0.78, "warning_to_hope": 0.82},
            "tags": ["龍", "翼", "空", "未来", "祝福", "いにしえ"],
            "summary": "見えない世界から届く声に応え、龍の翼で未来へ飛ぶ歌。いにしえの炎と祝福を思い出す。",
        },
        {
            "id": 142,
            "title": "GOD era",
            "axes": {"reality_to_cosmos": 0.82, "material_to_spiritual": 0.95, "warning_to_hope": 0.72},
            "tags": ["神", "愛", "再生", "燔祭", "祈り", "光"],
            "summary": "崩れゆく世界の中で、弱き罪を手放し、神代のしるしへ導かれる再生の歌。愛と祈りが時代をひらく。",
        },
        {
            "id": 143,
            "title": "草原、彼方のイノセンス",
            "axes": {"reality_to_cosmos": 0.55, "material_to_spiritual": 0.68, "warning_to_hope": 0.76},
            "tags": ["草原", "風", "彼方", "イノセンス", "影", "自然"],
            "summary": "草原の風に影をほどかれ、広い場所と無垢さを思い出す歌。騒がしい街の外へ心を運んでいく。",
        },
        {
            "id": 144,
            "title": "世界の扉",
            "axes": {"reality_to_cosmos": 0.45, "material_to_spiritual": 0.75, "warning_to_hope": 0.62},
            "tags": ["扉", "孤独", "祈り", "小さき手", "光", "解放"],
            "summary": "固く閉じられた扉の内側で、小さな祈りを守り抜く歌。闇が去り、世界の扉が開かれていく。",
        },
        {
            "id": 145,
            "title": "宇宙の呼吸",
            "axes": {"reality_to_cosmos": 0.92, "material_to_spiritual": 0.82, "warning_to_hope": 0.88},
            "tags": ["宇宙", "呼吸", "手", "星", "つながり", "愛"],
            "summary": "触れた手から宇宙の呼吸を感じ、孤独な虚空を愛で満たしていく歌。星の行き先を共に決める。",
        },
        {
            "id": 997,
            "title": "お誕生日ありがとう",
